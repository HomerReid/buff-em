...
\\
 ...
 &= 
 (\vb x-\vb Q)\cdot (\vb x^\prime-\vb Q^\prime) g(r)
\end{align}
\label{PsiVForms}
\end{subequations}
%====================================================================%
...
\begin{align*}
 ...
 \Psi_{A1}(\vb x-\vb x^\prime)
&=   h_{A1}(r) 
  + \bigg[ r^2 - \vb r \cdot \Delta \vb Q 
              - 2(\vb x-\vb Q)\cdot(\vb x^\prime - \vb Q^\prime)
    \bigg]\left[ \frac{1}{r}h_{A1}^\prime(r)\right]
\\
&\qquad
  - \bigg[ (\vb x-\vb Q)\cdot(\vb x^\prime - \vb Q^\prime)
    \bigg]h_{A1}^{\prime \prime}(r)
\\
%--------------------------------------------------------------------%
 \nabla_{\vb x} \nabla_{\vb x^\prime}
 \Psi_{A2}(\vb x-\vb x^\prime)
...
$$ - \frac{2}{r}h^\prime_{A3}(r) - h^{\prime\prime}_{A3}(r) = g(r).$$
...
\end{align*}
%====================================================================%
For example, if $g(r)=\frac{e^{ikr}}{4\pi r}$ then I find
\begin{align*}
 h_{A1}(r) &= -\frac{\texttt{ExpRel}(ikr,2)}{4\pi r} 
\\
 h_{A2}(r) &= +\frac{\texttt{ExpRel}(ikr,2)}{4\pi r^2} 
              -\frac{\texttt{ExpRel}(ikr,3)}{4\pi r^3} 
              -\frac{1}{3}
\\
 h_{A3}(r) &=
\end{align*}
