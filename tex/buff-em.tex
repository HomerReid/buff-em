...
the quantity $\vb E^* \cdot \vb E$ over the the interior of 
$\mc B_n$; here $\vb J$ is the \textit{total} current in $\mc B_n$,
consisting of both free and induced contributions:
...
\textit{momentum} from the source distribution $\vb J\supt{F}$ is 
obtained by integrating
the quantity $\vb J^* \cdot \vb E$ over the the interior of 
$\mc B_n$; here $\vb J$ is the \textit{total} current in $\mc B_n$,
consisting of both free and induced contributions:
