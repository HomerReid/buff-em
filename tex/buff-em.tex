...
{ \big\langle J\supt{F}_i(\vb r) J^{\text{\tiny{F}}*}_j(\vb r^\prime)
  \big\rangle
  = \frac{k}{\pi Z_0} \Theta(T) \delta(\vb r-\vb r^\prime) 
...
%====================================================================%
$$ \big\langle P \big\rangle = 4 kT \Delta\Omega $$
%====================================================================%
(where $\Delta\Omega$ is the effective measurement bandwidth,
...
\begin{align}
 ...
 &= \big\langle P \big \rangle R = 4k T R\, \Delta\Omega, \qquad 
\nn
 \big \langle I^2 \big\rangle 
 &= \frac{1}{R} \big\langle P \big \rangle 
  = \frac{4k T}{R} \Delta\Omega
...
\subsection*{Macroscopic noise from microscopic fluctuations}

Thus, consider a resistor consisting of a homogeneous cylinder of
...
%====================================================================%
$$ \vb J(\vb x, t) = \int \vb J(\vb x,\omega) e^{-i\omega t} \, d\omega. $$
%====================================================================%
...
%====================================================================%
\begin{align*}
 I(z,\omega)&=\int_A \vb J(\vbrho, z)\cdot \vbhat{n} \, d\vbrho
\intertext{or, in our specific geometry in which the cross section is
everywhere normal to the $z$ direction,}
 I(z,\omega)&=\int_A J_z(\vbrho, z) \, d\vbrho.
\end{align*}
%====================================================================%
Over a time interval of length $\tau$, the mean-square current passing 
through the plane at $z$ is 
%====================================================================%
\begin{align*} 
\big\langle I^2(z)\big\rangle
&=\frac{1}{\tau}\int_0^\tau I^2(z,t) \, dt
\\
